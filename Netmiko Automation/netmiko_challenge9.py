...
# executing commands
print('Sending the ACL commands...')
...
print('Running show access-lists...')
...
# ''' Output:
# C:\Users\belka\PycharmProjects\NetworkAutomation\venv\Scripts\python.exe "C:\Users\belka\PycharmProjects\NetworkAutomation\Netmiko Automation\netmiko_challenge9.py"
# SSH connection established to 10.1.1.10:22
# Interactive SSH session established
# Entering the enable mode...
# Sending the ACL commands...
# configure terminal
# Enter configuration commands, one per line.  End with CNTL/Z.
# CiscoRouter1(config)#access-list 101 permit tcp any any eq 80
# CiscoRouter1(config)#access-list 101 permit tcp any any eq 443
# CiscoRouter1(config)#access-list 101 deny ip any any
# CiscoRouter1(config)#end
# CiscoRouter1#
# Running show access-lists...
