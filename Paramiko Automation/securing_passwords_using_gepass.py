...
# Prompting the user for a password with the getpass method from getpass
# module to prove this works run the script using a Windows terminal cd
# into the working directory and ensure you have paramiko installed globally in
